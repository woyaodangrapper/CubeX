...
namespace XLauncher.GameSettings.Base
{
    internal class ImportExportBase
    {
        ...
        public Exception ImportSettings()
        {
            try
            {
                string path = FileDialogNative.GetFilePicker(new Dictionary<string, string> { { "X Registry", "*.clreg" } }, Lang._GameSettingsPage.SettingsRegImportTitle).GetAwaiter().GetResult();
        ...
        public Exception ExportSettings()
        {
            try
            {
                string path = FileDialogNative.GetFileSavePicker(new Dictionary<string, string> { { "X Registry", "*.clreg" } }, Lang._GameSettingsPage.SettingsRegExportTitle).GetAwaiter().GetResult();
