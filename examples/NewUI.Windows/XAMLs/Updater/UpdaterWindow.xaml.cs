...
namespace XLauncher
{
    public sealed partial class UpdaterWindow : Window
    {
        ...
        public static string launcherPath = Path.Combine(workingDir, "XLauncher.exe");
        ...
        public UpdaterWindow()
        {
            ...
            string title = $"X Launcher Updater";
            if (IsPreview)
        ...
        private async void StartAsyncRoutine()
        {
            try
            {
                string newVerTagPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "AppData", "LocalLow", "XLauncher", "_NewVer");
