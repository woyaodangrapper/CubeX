...
namespace XLauncher
{
    public partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            try
            {
                LogWriteLine($"Welcome to X Launcher v{AppCurrentVersion.VersionString} - {XLauncherProgram.GetVersionString()}", LogType.Default, false);
        ...
        private async void RunBackgroundCheck()
        {
            try
            {
                // Fetch the Notification Feed in XLauncher-Repo
        ...
        private bool IsLoadNotifComplete = false;
        ...
        private void GenerateLocalAppNotification()
        {
            NotificationData.AppPush.Add(new NotificationProp
            {
                ...
                OtherUIElement = GenerateNotificationButtonStartProcess(
                    "",
                    "https://github.com/neon-nyan/XLauncher/wiki",
            ...
            if (IsPreview)
            {
                NotificationData.AppPush.Add(new NotificationProp
                {
                    ...
                    OtherUIElement = GenerateNotificationButtonStartProcess(
                        "",
                        "https://github.com/neon-nyan/XLauncher/issues",
        ...
        private void Navigate(Type sourceType, bool hideImage, NavigationViewItem tag)
        {
