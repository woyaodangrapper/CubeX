...
using XLauncher.GameSettings.Honkai;
using XLauncher.GameSettings.StarRail;
using XLauncher.GameVersioning;
using XLauncher.InstallManager.Genshin;
using XLauncher.InstallManager.Honkai;
using XLauncher.InstallManager.StarRail;
